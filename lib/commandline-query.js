...
module.exports = function (input) {
  ...
  var highestTransactionIndex = transactions.length - 1
  ...
  return {
    ...
    exec: function (options) {
      ...
      function requestTransaction(statements) {
        console.log(highestTransactionIndex)
        var query = {
        ...
        .end(function (err, res) {
          ...
          if (body.errors.length) {
            ...
            if (highestTransactionIndex === -1) {

              d.notify(body.results)
              highestTransactionIndex--
              requestTransaction(transactions[highestTransactionIndex].statements)
