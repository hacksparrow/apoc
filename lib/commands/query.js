...
var getContent = require(__dirname + '/../acf-reader.js')
...
module.exports = function (input, vars) {
  ...
  else if (vars) queryText = template(input, vars)
  else queryText = input

  debug('Query Text:', queryText)

  var statements = [ { statement: queryText } ]

  var x = queryText.split(' \n')
  //console.log(x)
